            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="flex flex-col md:flex-row gap-8 md:gap-12">
                    <div className="w-full md:w-1/4">
                        <div className="w-48 h-72 md:w-full md:h-auto aspect-[2/3] rounded-lg bg-surface animate-pulse mb-6 mx-auto md:mx-0 border border-white/5"></div>
                    ...
                    <div className="w-full md:w-3/4">
                        <div className="h-10 md:h-12 w-1/2 bg-white/10 rounded mb-8"></div>
